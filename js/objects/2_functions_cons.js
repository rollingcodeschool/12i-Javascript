...
let pokemon5 = new Pokemon('Pikachu', 'Lighting', 55, 'Thunder');
let pokemon6 = new Pokemon('Pikachu', 'Lighting', 55, 'Thunder');
let pokemon7 = new Pokemon('Pikachu', 'Lighting', 55, 'Thunder');
